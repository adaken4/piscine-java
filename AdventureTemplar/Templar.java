...
// You will override toString method with the following format : <name> is a strong Templar with <currentHealth> HP. It can heal <healCapacity> HP and has a shield of <shield>. If its currentHeal is equal to 0, the format is <name> has been beaten, even with its <shield> shield. So bad, it could heal <healCapacity> HP.
